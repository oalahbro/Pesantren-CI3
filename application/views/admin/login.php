...
<head>
    ...
    <!-- General CSS Files -->
    <link rel="stylesheet" href="<?php echo base_url("assets/admin/assets/bootstrap/bootstrap.min.css") ?>">
...
<body class="bg-prymary">
    ...
    <body>
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                            <div class="login-brand">
                                <img src="https://wahdicenter.id/wp-content/uploads/2023/09/logo-wahdi-center.png?w=200" alt="logo" width="100" class="shadow-light rounded-circle">
                            </div>
        ...
        <script src="<?php echo base_url("assets/admin/assets/bootstrap/stisla.js") ?>"></script>

        <!-- Template JS File -->
        <script src="<?php echo base_url("assets/admin/assets/bootstrap/scripts.js") ?>"></script>
        <script src="<?php echo base_url("assets/admin/assets/bootstrap/custom.js") ?>"></script>
